...
const fetchData = async () => {
    ...
    try {
        ...
        console.error('Error fetching admin points details:', error);
    } finally {
...
<template>
    <div class="detail-page p-4">
        <div class="flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h1 class="text-2xl font-bold m-0">Tüm Kazanılan Puanlar</h1>
                <p class="text-secondary m-0">Tüm firmaların kampanyalarından kazanılan puan detayları</p>
            </div>
        </div>
        ...
        <div class="card">
            ...
            >
                ...
                <Column field="points" header="Puan" sortable style="min-width: 90px">
                    <template #body="{ data }">
                        <span class="font-bold text-purple-500">+{{ data.points }}</span>
                    </template>
                </Column>

                <Column field="campaign" header="Detay" style="min-width: 180px">
                    <template #body="{ data }">
